...
;              
CREATE USER IF NOT EXISTS "SA" SALT '20f2b1d6dbd3ef09' HASH '7e5a9792007c3b50486cfab67507e11340ea6c6500a9ebec4b99cbcfc3a8d42e' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TRUE, TRUE, '$2a$10$jAtRaHH5Xp9R.Cda1yg2yeDmnrJ/1ftL1EZzUqfGALktfW3bCl4H.', NULL, 'admin', 1);    
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(2, '5935fb0b-5b5f-4379-837a-607aecd4ef66', 'web', TRUE, FALSE, '$2a$10$jgUiRQAF/LhXrHOfN3qZEOYeUDqBYn6Plg9yMi7Gcqtyg0MnPT5xC', NULL, 'STIRLING-PDF-BACKEND-API-USER', 2);         
